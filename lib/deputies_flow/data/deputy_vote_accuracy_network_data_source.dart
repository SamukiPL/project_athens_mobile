...
class VoteSlimMajorityModelNetworkDataSource extends NetworkListDataSource<VoteSlimMajorityModel, DeputyVoteAccuracyListParams> {

  final DeputiesDetailsApi _deputiesDetailsApi;
  final VoteSlimMajorityNetworkMapper _networkMapper;

  VoteSlimMajorityModelNetworkDataSource(this._deputiesDetailsApi, this._networkMapper);

  @override
  Future<Result<List<VoteSlimMajorityModel>>> call(DeputyVoteAccuracyListParams params) async {
    try {
