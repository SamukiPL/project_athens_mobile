...
class DeputyVotingsDetailsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final blocContainer = Provider.of<DeputyVotesDetailsBlocContainer>(context);

    return Column(
        mainAxisSize: MainAxisSize.max,
        children: [
          Expanded(
            child: BaseListWidget(listBloc: blocContainer.listBloc, noDataText: localizations.getText().votingsNoData(),),
          )
        ]
    );
  }
