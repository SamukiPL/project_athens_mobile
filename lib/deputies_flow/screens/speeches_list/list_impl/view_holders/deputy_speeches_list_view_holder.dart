...
class DeputySpeechListViewHolder extends StatelessWidget with RedirectionDelegate {
  final DeputySpeechListItemViewModel _viewModel;

  const DeputySpeechListViewHolder(this._viewModel, {Key? key}) : super(key: key);
