...
class VoteSlimMajorityModel extends VoteSlimModel {
  ...
  final ParliamentClubMapper desiredClub;
  final VoteType desiredClubVote;

  VoteSlimMajorityModel({this.desiredClub, this.desiredDeputy, this.desiredClubVote, this.desiredDeputyVote, String id, VotingType type, DateTime voteAt, VoteNumbers voteNumbers, }) : super(id: id, type: type, voteAt: voteAt, voteNumbers: voteNumbers);
}