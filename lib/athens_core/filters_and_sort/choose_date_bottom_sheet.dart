...
Future<DateTime> showDateChooserBottomSheet(BuildContext parentContext, {DateTime firstSelectedDate, DateTime minDate, DateTime maxDate}) {
...
class _DateChooserBottomSheet extends StatelessWidget {
  ...
  const _DateChooserBottomSheet({Key key, this.parentContext, this.firstSelectedDate, this.minDate, this.maxDate}) : super(key: key);
