...
class NotificationListViewHolder extends StatelessWidget with RedirectionDelegate {
    ...
    return ChangeNotifierProvider.value(
      ...
      child: Consumer<NotificationListItemViewModel>(
        builder: (context, viewModel, _) => GestureDetector(
          onTap: () {
            NotificationsService.instance?.openDestinationFromNotification(viewModel.model);
  ...
  Widget _getTitleAndDateRow(ThemeData theme, NotificationListItemViewModel viewModel) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text(
            ...
            style: TextStyle(
                color: viewModel.model.isRead ? theme.dividerColor : theme.primaryColor,
                fontSize: 14,
                fontWeight: viewModel.model.isRead ? FontWeight.normal : FontWeight.bold
            ),
          ),
          Text(
  ...
  Widget _getDescriptionRow(ThemeData theme, NotificationListItemViewModel viewModel) {
    return Container(
