...
class CalendarDatePickerCustom extends StatefulWidget {
  ...
  @override
  _CalendarDatePickerCustomState createState() => _CalendarDatePickerCustomState();
}
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  void initState() {
    ...
    _pageController = PageController(initialPage: monthDelta(widget.firstDate, _currentMonth));
  }
  ...
  void _handleMonthPageChanged(int monthPage) {
    final DateTime monthDate = addMonthsToMonthDate(widget.firstDate, monthPage);
