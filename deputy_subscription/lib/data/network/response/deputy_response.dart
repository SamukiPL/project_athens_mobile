...
class DeputyResponse {
  ...
  DeputyResponse(this.id, this.cadency, this.name, this.reversedName, this.politicalParty, this.parliamentClub, this.cardNumber, this.deputyId, this.isAcitve, this.cv, this.contact, this.createAt);
