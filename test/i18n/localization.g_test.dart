...
void main() {
  ...
  String filePathForCoverage = osPrefix +
      scriptPath.substring(0, scriptPath.indexOf('main.dart')).substring(1) +
      'resources/lang/';
...
void testAllMethods(String locale, AppLocalizationsGenerated localization) {
  ...
  test("All methods for $locale universalNoDataDefaultText", () async {
    String universalNoDataDefaultText =
        localization.universalNoDataDefaultText();
    expect(true,
        universalNoDataDefaultText != "" && universalNoDataDefaultText != null);
  });
  ...
  test("All methods for $locale universalUpdateCupertinoDialogTitle", () async {
    String universalUpdateCupertinoDialogTitle =
        localization.universalUpdateCupertinoDialogTitle();
    expect(
        true,
        universalUpdateCupertinoDialogTitle != "" &&
            universalUpdateCupertinoDialogTitle != null);
  });

  test("All methods for $locale universalUpdateCupertinoDialogButtonIgnore",
      () async {
    String universalUpdateCupertinoDialogButtonIgnore =
        localization.universalUpdateCupertinoDialogButtonIgnore();
    expect(
        true,
        universalUpdateCupertinoDialogButtonIgnore != "" &&
            universalUpdateCupertinoDialogButtonIgnore != null);
  });

  test("All methods for $locale universalUpdateCupertinoDialogButtonLater",
      () async {
    String universalUpdateCupertinoDialogButtonLater =
        localization.universalUpdateCupertinoDialogButtonLater();
    expect(
        true,
        universalUpdateCupertinoDialogButtonLater != "" &&
            universalUpdateCupertinoDialogButtonLater != null);
  });

  test("All methods for $locale universalUpdateCupertinoDialogButtonUpdateNow",
      () async {
    String universalUpdateCupertinoDialogButtonUpdateNow =
        localization.universalUpdateCupertinoDialogButtonUpdateNow();
    expect(
        true,
        universalUpdateCupertinoDialogButtonUpdateNow != "" &&
            universalUpdateCupertinoDialogButtonUpdateNow != null);
  });

  test(
      "All methods for $locale universalUpdateCupertinoDialogWouldYouLikeToUpdateAppNow",
      () async {
    String universalUpdateCupertinoDialogWouldYouLikeToUpdateAppNow =
        localization.universalUpdateCupertinoDialogWouldYouLikeToUpdateAppNow();
    expect(
        true,
        universalUpdateCupertinoDialogWouldYouLikeToUpdateAppNow != "" &&
            universalUpdateCupertinoDialogWouldYouLikeToUpdateAppNow != null);
  });
  ...
  test("All methods for $locale mainMenuCharactersCards", () async {
    ...
    expect(
        true, mainMenuCharactersCards != "" && mainMenuCharactersCards != null);
  });
  ...
  test("All methods for $locale mainMenuActiveSessions", () async {
    ...
    expect(
        true, mainMenuActiveSessions != "" && mainMenuActiveSessions != null);
  });
  ...
  test("All methods for $locale loginButtonsResetPassword", () async {
    ...
    expect(true,
        loginButtonsResetPassword != "" && loginButtonsResetPassword != null);
  });
  ...
  test("All methods for $locale loginHintsRepeatPassword", () async {
    ...
    expect(true,
        loginHintsRepeatPassword != "" && loginHintsRepeatPassword != null);
  });
  ...
  test("All methods for $locale loginOtherForgotRationale", () async {
    ...
    expect(true,
        loginOtherForgotRationale != "" && loginOtherForgotRationale != null);
  });
  ...
  test("All methods for $locale loginValidateFieldCannotBeEmpty", () async {
    String loginValidateFieldCannotBeEmpty =
        localization.loginValidateFieldCannotBeEmpty();
    expect(
        true,
        loginValidateFieldCannotBeEmpty != "" &&
            loginValidateFieldCannotBeEmpty != null);
  });

  test("All methods for $locale loginValidateIncorrectEmail", () async {
    String loginValidateIncorrectEmail =
        localization.loginValidateIncorrectEmail();
    expect(
        true,
        loginValidateIncorrectEmail != "" &&
            loginValidateIncorrectEmail != null);
  });
  ...
  test("All methods for $locale loginValidateLoginIsTaken", () async {
    ...
    expect(true,
        loginValidateLoginIsTaken != "" && loginValidateLoginIsTaken != null);
  });
  ...
  test("All methods for $locale loginValidateEmailIsTaken", () async {
    ...
    expect(true,
        loginValidateEmailIsTaken != "" && loginValidateEmailIsTaken != null);
  });

  test("All methods for $locale loginValidateEmailsDontMatch", () async {
    String loginValidateEmailsDontMatch =
        localization.loginValidateEmailsDontMatch();
    expect(
        true,
        loginValidateEmailsDontMatch != "" &&
            loginValidateEmailsDontMatch != null);
  });

  test("All methods for $locale loginValidatePasswordsDontMatch", () async {
    String loginValidatePasswordsDontMatch =
        localization.loginValidatePasswordsDontMatch();
    expect(
        true,
        loginValidatePasswordsDontMatch != "" &&
            loginValidatePasswordsDontMatch != null);
  });
  ...
  test("All methods for $locale loginValidateWrongData", () async {
    ...
    expect(
        true, loginValidateWrongData != "" && loginValidateWrongData != null);
  });

  test("All methods for $locale loginErrorPasswordOrLoginDoesNotMatch",
      () async {
    String loginErrorPasswordOrLoginDoesNotMatch =
        localization.loginErrorPasswordOrLoginDoesNotMatch();
    expect(
        true,
        loginErrorPasswordOrLoginDoesNotMatch != "" &&
            loginErrorPasswordOrLoginDoesNotMatch != null);
  });
  ...
  test("All methods for $locale timelineTimelineNavTitle", () async {
    ...
    expect(true,
        timelineTimelineNavTitle != "" && timelineTimelineNavTitle != null);
  });

  test("All methods for $locale timelineVotingTypesResolutionProject",
      () async {
    String timelineVotingTypesResolutionProject =
        localization.timelineVotingTypesResolutionProject();
    expect(
        true,
        timelineVotingTypesResolutionProject != "" &&
            timelineVotingTypesResolutionProject != null);
  });

  test("All methods for $locale timelineVotingTypesLawProject", () async {
    String timelineVotingTypesLawProject =
        localization.timelineVotingTypesLawProject();
    expect(
        true,
        timelineVotingTypesLawProject != "" &&
            timelineVotingTypesLawProject != null);
  });
  ...
  test("All methods for $locale timelineVotingTypesBreak", () async {
    ...
    expect(true,
        timelineVotingTypesBreak != "" && timelineVotingTypesBreak != null);
  });
  ...
  test("All methods for $locale timelineVotingTypesQuorum", () async {
    ...
    expect(true,
        timelineVotingTypesQuorum != "" && timelineVotingTypesQuorum != null);
  });
  ...
  test("All methods for $locale timelineVotingTypesReport", () async {
    ...
    expect(true,
        timelineVotingTypesReport != "" && timelineVotingTypesReport != null);
  });

  test("All methods for $locale timelineVotingTypesVoteOfNoConfidence",
      () async {
    String timelineVotingTypesVoteOfNoConfidence =
        localization.timelineVotingTypesVoteOfNoConfidence();
    expect(
        true,
        timelineVotingTypesVoteOfNoConfidence != "" &&
            timelineVotingTypesVoteOfNoConfidence != null);
  });

  test("All methods for $locale timelineVotingTypesCompletionOfAgenda",
      () async {
    String timelineVotingTypesCompletionOfAgenda =
        localization.timelineVotingTypesCompletionOfAgenda();
    expect(
        true,
        timelineVotingTypesCompletionOfAgenda != "" &&
            timelineVotingTypesCompletionOfAgenda != null);
  });

  test("All methods for $locale timelineVotingTypesShorteningDeadline",
      () async {
    String timelineVotingTypesShorteningDeadline =
        localization.timelineVotingTypesShorteningDeadline();
    expect(
        true,
        timelineVotingTypesShorteningDeadline != "" &&
            timelineVotingTypesShorteningDeadline != null);
  });

  test("All methods for $locale timelineVotingTypesChangeCommissionMembers",
      () async {
    String timelineVotingTypesChangeCommissionMembers =
        localization.timelineVotingTypesChangeCommissionMembers();
    expect(
        true,
        timelineVotingTypesChangeCommissionMembers != "" &&
            timelineVotingTypesChangeCommissionMembers != null);
  });

  test("All methods for $locale timelineVotingTypesVoteForProposal", () async {
    String timelineVotingTypesVoteForProposal =
        localization.timelineVotingTypesVoteForProposal();
    expect(
        true,
        timelineVotingTypesVoteForProposal != "" &&
            timelineVotingTypesVoteForProposal != null);
  });

  test("All methods for $locale timelineVotingTypesPersonVote", () async {
    String timelineVotingTypesPersonVote =
        localization.timelineVotingTypesPersonVote();
    expect(
        true,
        timelineVotingTypesPersonVote != "" &&
            timelineVotingTypesPersonVote != null);
  });

  test(
      "All methods for $locale timelineVotingTypesVoteForPostponementGathering",
      () async {
    String timelineVotingTypesVoteForPostponementGathering =
        localization.timelineVotingTypesVoteForPostponementGathering();
    expect(
        true,
        timelineVotingTypesVoteForPostponementGathering != "" &&
            timelineVotingTypesVoteForPostponementGathering != null);
  });

  test("All methods for $locale timelineVotingTypesMarshal", () async {
    String timelineVotingTypesMarshal =
        localization.timelineVotingTypesMarshal();
    expect(true,
        timelineVotingTypesMarshal != "" && timelineVotingTypesMarshal != null);
  });

  test("All methods for $locale timelineVotingTypesViceMarshal", () async {
    String timelineVotingTypesViceMarshal =
        localization.timelineVotingTypesViceMarshal();
    expect(
        true,
        timelineVotingTypesViceMarshal != "" &&
            timelineVotingTypesViceMarshal != null);
  });

  test("All methods for $locale timelineVotingTypesChooseComissionMembers",
      () async {
    String timelineVotingTypesChooseComissionMembers =
        localization.timelineVotingTypesChooseComissionMembers();
    expect(
        true,
        timelineVotingTypesChooseComissionMembers != "" &&
            timelineVotingTypesChooseComissionMembers != null);
  });

  test(
      "All methods for $locale timelineVotingTypesSelectionOfParliamentSecretaries",
      () async {
    String timelineVotingTypesSelectionOfParliamentSecretaries =
        localization.timelineVotingTypesSelectionOfParliamentSecretaries();
    expect(
        true,
        timelineVotingTypesSelectionOfParliamentSecretaries != "" &&
            timelineVotingTypesSelectionOfParliamentSecretaries != null);
  });

  test("All methods for $locale timelineVotingTypesVoteOfConfidence", () async {
    String timelineVotingTypesVoteOfConfidence =
        localization.timelineVotingTypesVoteOfConfidence();
    expect(
        true,
        timelineVotingTypesVoteOfConfidence != "" &&
            timelineVotingTypesVoteOfConfidence != null);
  });

  test("All methods for $locale timelineVotingTypesSelectionOfStateTribunal",
      () async {
    String timelineVotingTypesSelectionOfStateTribunal =
        localization.timelineVotingTypesSelectionOfStateTribunal();
    expect(
        true,
        timelineVotingTypesSelectionOfStateTribunal != "" &&
            timelineVotingTypesSelectionOfStateTribunal != null);
  });

  test(
      "All methods for $locale timelineVotingTypesSelectionOfConstitutionalCourt",
      () async {
    String timelineVotingTypesSelectionOfConstitutionalCourt =
        localization.timelineVotingTypesSelectionOfConstitutionalCourt();
    expect(
        true,
        timelineVotingTypesSelectionOfConstitutionalCourt != "" &&
            timelineVotingTypesSelectionOfConstitutionalCourt != null);
  });

  test(
      "All methods for $locale timelineVotingTypesSelectionOfNationalCouncilJudiciary",
      () async {
    String timelineVotingTypesSelectionOfNationalCouncilJudiciary =
        localization.timelineVotingTypesSelectionOfNationalCouncilJudiciary();
    expect(
        true,
        timelineVotingTypesSelectionOfNationalCouncilJudiciary != "" &&
            timelineVotingTypesSelectionOfNationalCouncilJudiciary != null);
  });

  test("All methods for $locale timelineVotingTypesUnknown", () async {
    String timelineVotingTypesUnknown =
        localization.timelineVotingTypesUnknown();
    expect(true,
        timelineVotingTypesUnknown != "" && timelineVotingTypesUnknown != null);
  });
  ...
  test("All methods for $locale timelineNounCloudNoNouns", () async {
    ...
    expect(true,
        timelineNounCloudNoNouns != "" && timelineNounCloudNoNouns != null);
  });
  ...
  test("All methods for $locale deputiesDeputiesListTitle", () async {
    ...
    expect(true,
        deputiesDeputiesListTitle != "" && deputiesDeputiesListTitle != null);
  });
  ...
  test("All methods for $locale deputiesFinishedSchools", () async {
    ...
    expect(
        true, deputiesFinishedSchools != "" && deputiesFinishedSchools != null);
  });

  test("All methods for $locale deputiesParliamentExperience", () async {
    String deputiesParliamentExperience =
        localization.deputiesParliamentExperience();
    expect(
        true,
        deputiesParliamentExperience != "" &&
            deputiesParliamentExperience != null);
  });
  ...
  test("All methods for $locale deputiesNoHighestAccuracy", () async {
    ...
    expect(true,
        deputiesNoHighestAccuracy != "" && deputiesNoHighestAccuracy != null);
  });
  ...
  test("All methods for $locale deputiesStatisticsInfo", () async {
    ...
    expect(
        true, deputiesStatisticsInfo != "" && deputiesStatisticsInfo != null);
  });
  ...
  test("All methods for $locale deputiesNotSubscribingDeputy", () async {
    String deputiesNotSubscribingDeputy =
        localization.deputiesNotSubscribingDeputy();
    expect(
        true,
        deputiesNotSubscribingDeputy != "" &&
            deputiesNotSubscribingDeputy != null);
  });
  ...
  test("All methods for $locale deputiesSubscribingDeputy", () async {
    ...
    expect(true,
        deputiesSubscribingDeputy != "" && deputiesSubscribingDeputy != null);
  });
  ...
  test("All methods for $locale speechesSpeechesListTitle", () async {
    ...
    expect(true,
        speechesSpeechesListTitle != "" && speechesSpeechesListTitle != null);
  });

  test("All methods for $locale speechesSpeechDetailsTitle", () async {
    String speechesSpeechDetailsTitle =
        localization.speechesSpeechDetailsTitle();
    expect(true,
        speechesSpeechDetailsTitle != "" && speechesSpeechDetailsTitle != null);
  });
  ...
  test("All methods for $locale speechesPreviousSpeech", () async {
    ...
    expect(
        true, speechesPreviousSpeech != "" && speechesPreviousSpeech != null);
  });
  ...
  test("All methods for $locale votingsVotingListTitle", () async {
    ...
    expect(
        true, votingsVotingListTitle != "" && votingsVotingListTitle != null);
  });

  test("All methods for $locale votingsVoteTypesTotalDeputiesPlural", () async {
    String votingsVoteTypesTotalDeputiesPlural =
        localization.votingsVoteTypesTotalDeputiesPlural();
    expect(
        true,
        votingsVoteTypesTotalDeputiesPlural != "" &&
            votingsVoteTypesTotalDeputiesPlural != null);
  });

  test("All methods for $locale votingsVoteTypesActualVotedDeputiesPlural",
      () async {
    String votingsVoteTypesActualVotedDeputiesPlural =
        localization.votingsVoteTypesActualVotedDeputiesPlural();
    expect(
        true,
        votingsVoteTypesActualVotedDeputiesPlural != "" &&
            votingsVoteTypesActualVotedDeputiesPlural != null);
  });

  test("All methods for $locale votingsVoteTypesInFavorSingle", () async {
    String votingsVoteTypesInFavorSingle =
        localization.votingsVoteTypesInFavorSingle();
    expect(
        true,
        votingsVoteTypesInFavorSingle != "" &&
            votingsVoteTypesInFavorSingle != null);
  });
  ...
  test("All methods for $locale votingsVoteTypesInFavor", () async {
    ...
    expect(
        true, votingsVoteTypesInFavor != "" && votingsVoteTypesInFavor != null);
  });

  test("All methods for $locale votingsVoteTypesAgainstSingle", () async {
    String votingsVoteTypesAgainstSingle =
        localization.votingsVoteTypesAgainstSingle();
    expect(
        true,
        votingsVoteTypesAgainstSingle != "" &&
            votingsVoteTypesAgainstSingle != null);
  });
  ...
  test("All methods for $locale votingsVoteTypesAgainst", () async {
    ...
    expect(
        true, votingsVoteTypesAgainst != "" && votingsVoteTypesAgainst != null);
  });

  test("All methods for $locale votingsVoteTypesHoldPlural", () async {
    String votingsVoteTypesHoldPlural =
        localization.votingsVoteTypesHoldPlural();
    expect(true,
        votingsVoteTypesHoldPlural != "" && votingsVoteTypesHoldPlural != null);
  });

  test("All methods for $locale votingsVoteTypesAbsentPlural", () async {
    String votingsVoteTypesAbsentPlural =
        localization.votingsVoteTypesAbsentPlural();
    expect(
        true,
        votingsVoteTypesAbsentPlural != "" &&
            votingsVoteTypesAbsentPlural != null);
  });

  test("All methods for $locale votingsVoteTypesHoldSingle", () async {
    String votingsVoteTypesHoldSingle =
        localization.votingsVoteTypesHoldSingle();
    expect(true,
        votingsVoteTypesHoldSingle != "" && votingsVoteTypesHoldSingle != null);
  });

  test("All methods for $locale votingsVoteTypesAbsentSingle", () async {
    String votingsVoteTypesAbsentSingle =
        localization.votingsVoteTypesAbsentSingle();
    expect(
        true,
        votingsVoteTypesAbsentSingle != "" &&
            votingsVoteTypesAbsentSingle != null);
  });

  test("All methods for $locale votingsSubscribedDeputiesVotes", () async {
    String votingsSubscribedDeputiesVotes =
        localization.votingsSubscribedDeputiesVotes();
    expect(
        true,
        votingsSubscribedDeputiesVotes != "" &&
            votingsSubscribedDeputiesVotes != null);
  });
  ...
  test("All methods for $locale votingsVotesNeededToPass", () async {
    ...
    expect(true,
        votingsVotesNeededToPass != "" && votingsVotesNeededToPass != null);
  });
  ...
  test("All methods for $locale settingsSwitchTechnicalData", () async {
    String settingsSwitchTechnicalData =
        localization.settingsSwitchTechnicalData();
    expect(
        true,
        settingsSwitchTechnicalData != "" &&
            settingsSwitchTechnicalData != null);
  });

  test("All methods for $locale settingsSwitchWakelockTimeline", () async {
    String settingsSwitchWakelockTimeline =
        localization.settingsSwitchWakelockTimeline();
    expect(
        true,
        settingsSwitchWakelockTimeline != "" &&
            settingsSwitchWakelockTimeline != null);
  });
  ...
  test("All methods for $locale settingsHallOfFameTitle", () async {
    ...
    expect(
        true, settingsHallOfFameTitle != "" && settingsHallOfFameTitle != null);
  });
  ...
  test("All methods for $locale filtersFiltersDateFrom", () async {
    ...
    expect(
        true, filtersFiltersDateFrom != "" && filtersFiltersDateFrom != null);
  });
  ...
  test("All methods for $locale filtersFiltersSearchPhrase", () async {
    String filtersFiltersSearchPhrase =
        localization.filtersFiltersSearchPhrase();
    expect(true,
        filtersFiltersSearchPhrase != "" && filtersFiltersSearchPhrase != null);
  });
