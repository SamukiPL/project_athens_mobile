...
void testAllMethods(String locale, AppLocalizationsGenerated localization) {
  ...
  test("All methods for $locale universalNoConnectionTitle", () async {
    String universalNoConnectionTitle = localization.universalNoConnectionTitle();
    expect(true, universalNoConnectionTitle != ""); 
  }); 
 
  test("All methods for $locale universalNoConnectionDescription", () async {
    String universalNoConnectionDescription = localization.universalNoConnectionDescription();
    expect(true, universalNoConnectionDescription != ""); 
  }); 
  ...
  test("All methods for $locale universalErrorNoConnection", () async {
    String universalErrorNoConnection = localization.universalErrorNoConnection();
    expect(true, universalErrorNoConnection != ""); 
  }); 
  ...
  test("All methods for $locale deputiesSpeechesList", () async {
    String deputiesSpeechesList = localization.deputiesSpeechesList();
    expect(true, deputiesSpeechesList != ""); 
  }); 
 
  test("All methods for $locale deputiesVotesList", () async {
    String deputiesVotesList = localization.deputiesVotesList();
    expect(true, deputiesVotesList != ""); 
  }); 
 
  test("All methods for $locale deputiesActivities", () async {
    String deputiesActivities = localization.deputiesActivities();
    expect(true, deputiesActivities != ""); 
  }); 
