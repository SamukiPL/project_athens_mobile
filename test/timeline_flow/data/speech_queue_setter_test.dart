...
void main() {
  ...
  test("provide next person speech correct data test", () {
    ...
    final forFirstItem = queueSetter.provideNextPersonModel(0, list);
  ...
  test("provide previous person speech correct data test", () {
    ...
    final forSecondItem = queueSetter.providePreviousPersonModel(1, list);
...
List<SpeechModel> _mockSpeechList() => [
  SpeechModel(id: "1", previousPersonSpeech: PersonSpeechModel()),
  SpeechModel(id: "2"),
  SpeechModel(id: "3"),
  SpeechModel(id: "4"),
  SpeechModel(id: "5", nextPersonSpeech: PersonSpeechModel()),
];

List<TimelineModel> _mockTimelineList() => [
  VotingModel(),
  VotingModel(),
  SpeechModel(id: "1", previousPersonSpeech: PersonSpeechModel(), date: DateTime.now().add(Duration(hours: 5))),
  VotingModel(),
  VotingModel(),
  SpeechModel(id: "2", date: DateTime.now().add(Duration(hours: 4))),
  SpeechModel(id: "3", date: DateTime.now().add(Duration(hours: 3))),
  VotingModel(),
  SpeechModel(id: "4", date: DateTime.now().add(Duration(hours: 2))),
  VotingModel(),
  SpeechModel(id: "5", nextPersonSpeech: PersonSpeechModel(), date: DateTime.now().add(Duration(hours: 1))),
  VotingModel(),
  VotingModel(),
];